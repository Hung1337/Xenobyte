...
public class Rand {
	...
	private static String[] formatColors = { "1", "2", "3", "4", "5", "6", "7", "8", "9", "a", "b", "c", "d", "e",
			"f" };

	private static final String[] splashes = { "Жизнь боль, когда дебажки ноль", "Хыыы ёпта бля",
			"За веранду и двор стреляю в упор", "МАЙНКРАФТ СУКА ЭТО МОЯ ЖИЗНЬ", "ЩАС ПОФИКШУ (с)4epB9Ik",
			"Иди уроки учи добоиб", "ВАМ БАН СЕР", "LiteLoader Fuck Team", "БУНД БЛЯТ!!1",
			"Интеллектуально (с)radioegor146", "EHacks потик", "Тупа бан", "Взлом жоп", "Продам EHack",
			"vk.com/forgefuck", "LUASUCC" };
