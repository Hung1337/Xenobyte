...
public class GuiWidget extends TextElement {
	...
	public GuiWidget(String text, WidgetMode mode, ElementAligment indicatorAligment, int bgColor, int delay) {
		super(text, indicatorAligment == ElementAligment.LEFT ? ElementAligment.RIGHT : ElementAligment.LEFT,
				indicatorWidth + (indicatorAligment == ElementAligment.LEFT ? 1 : 0), 0);
