	...
	public void onPerform(PerformSource src) {
		...
		try {
			if (Class.forName("buildcraft.builders.TileConstructionMarker").isInstance(checkTile)) {
				...
				ByteBuf buf = utils.bufWriter((short) 0, x, (short) y, z, (byte) 0, x, (short) y, z, x, (short) y, z,
						(byte) 2);
				Class.forName("buildcraft.core.lib.utils.NetworkUtils")
						.getMethod("writeStack", ByteBuf.class, ItemStack.class)
						.invoke(null, buf, giveSelector().givedItem());
