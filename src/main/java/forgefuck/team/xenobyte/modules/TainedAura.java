...
public class TainedAura extends CheatModule {
	...
	private void sendTainedPacket(Entity e) {
		if (e != null) {
			...
			utils.sendPacket("taintedmagic", (byte) 0, e.getEntityId(), sourceId, utils.worldId(), Float.MAX_VALUE,
					withSound);
		}
	}
	...
	public String moduleDesc() {
		return "Ваншотает живность по ЛКМ";
	}
